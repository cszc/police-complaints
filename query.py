...
def go():
    ...
    invest_sel = "(SELECT * FROM investigator_beat_dum1 NATURAL JOIN investigator_beat_dum2) as dummies \
    ...
    query = "SELECT * FROM (SELECT crid, officer_id, tractce10 FROM allegations) as alleg JOIN \
