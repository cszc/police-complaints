...
def go(output_fn):
    ...
    alleg = "SELECT crid, a.officer_id, a.dateobj, a.cat_id, (CASE WHEN a.finding_edit = 'No Affidavit' THEN 1 ELSE 0 END) AS no_affidavit,\
    ...
    df_final = pd.concat([df_final, rank_dummies, gender_dummies, complainant_dummies, cat_dummies], axis = 1)
    df_final.drop(['tract_1', 'tractce10', 'officer_race', 'rank', 'officer_gender', 'complainant_gender', 'complainant_race', 'cat_id'], axis = 1, inplace = True)
