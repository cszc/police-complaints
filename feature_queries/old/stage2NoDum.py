...
def go(output_fn):
    ...
    alleg = "SELECT crid, a.officer_id, a.dateobj, beat, i.investigator_id, o.race_edit AS officer_race, o.gender AS officer_gender, \
    ...
    df_final.drop(['crid'], axis = 1, inplace = True)
