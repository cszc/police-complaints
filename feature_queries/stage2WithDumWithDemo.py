...
def go(output_fn):
    ...
    alleg = "SELECT crid, a.officer_id, a.dateobj, a.cat_id, tractce10, o.race_edit AS officer_race, o.gender AS officer_gender, \
    ...
    df_final.drop(['cat_id', 'tract_1', 'tractce10', 'officer_race', 'rank', 'officer_gender', 'complainant_gender', 'complainant_race'], axis = 1, inplace = True)
